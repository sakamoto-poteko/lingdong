...
(0, _jquery2.default)(function () {
    ...
    (0, _jquery2.default)('.bg').on('mousemove click', function (e) {
        var lMouseX = Math.max(-100, Math.min(100, (0, _jquery2.default)(window).width() / 2 - e.clientX));
        var lMouseY = Math.max(-100, Math.min(100, (0, _jquery2.default)(window).height() / 2 - e.clientY));
